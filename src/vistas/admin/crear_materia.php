...
<head>
    ...
    <title>Crear Materia - Administrador</title>
    ...
    <div class="container mt-4">
            ...
            <div class="col-12">
                <div class="card bg-warning text-white">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-0">Agregar una nueva materia al sistema</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="index.php?accion=guardar_materia_admin">
                            <div class="mb-3">
                                <label for="codigo" class="form-label">Código de la Materia *</label>
                                <input type="text" class="form-control" id="codigo" name="codigo" 
                                       maxlength="2" required placeholder="Ej: MA, CI, ES">
                                <div class="form-text">Máximo 2 caracteres (ej: MA para Matemáticas)</div>
                            </div>
        ...
        <div class="row mt-4">
            <div class="col-md-6 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">📋 Materias Existentes</h5>
                    </div>
                    <div class="card-body">
                        <?php
                        $stmt = $pdo->query("SELECT * FROM materias ORDER BY cod_categoria");
                        $materias = $stmt->fetchAll();
                        
                        if (empty($materias)) {
                            echo '<p class="text-muted">No hay materias registradas.</p>';
                        } else {
                            ...
                            foreach ($materias as $materia) {
                                echo '<tr>';
                                echo '<td><code>' . $materia['cod_categoria'] . '</code></td>';
